...
<p>The most up-to-date and current source code, binaries, documentation, news, etc., is available on the official website of Python https://www.python.org/
...
If the binary code for your platform is not available, you need a C compiler to compile the source code manually. Compiling the source code offers more flexibility in terms of choice of features that you require in your installation.</p>
<p>Here is a quick overview of installing Python on various platforms −</p>
<p>Unix and Linux Installation
Here are the simple steps to install Python on Unix/Linux machine.</p>
...
<li>Editing the Modules/Setup file if you want to customize some options.</li>
<li>run ./configure script</li>
<li>make install</li>
<p>This installs Python at standard location /usr/local/bin and its libraries at /usr/local/lib/pythonXX where XX is the version of Python.
Windows Installation
Here are the steps to install Python on Windows machine.</p>
<li>Open a Web browser and go to https://www.python.org/downloads/.</li>
<li>Follow the link for the Windows installer python-XYZ.msi file where XYZ is the version you need to install.</li>
<li>To use this installer python-XYZ.msi, the Windows system must support Microsoft Installer 2.0. Save the installer file to your local machine and then run it to find out if your machine supports MSI.</li>
...
To add the Python directory to the path for a particular session in Unix −</p>
<li>In the csh shell − type setenv PATH "$PATH:/usr/local/bin/python" and press Enter.</li>
<li>In the bash shell (Linux) − type export PATH="$PATH:/usr/local/bin/python" and press Enter.</li>
<li>In the sh or ksh shell − type PATH="$PATH:/usr/local/bin/python" and press Enter.</li>
<li>Note − /usr/local/bin/python is the path of the Python directory.</li>
<p>Setting path at Windows
To add the Python directory to the path for a particular session in Windows −
At the command prompt − type path %path%;
<p>C:\Python and press Enter.</p>
Note − C:\Python is the path of the Python directory</p>
